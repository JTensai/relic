...
//				#if UNITY_EDITOR
//				if (renderer != null){
//					// Added to hardcode a specific value for lightmapping purposes -Jordan
////					Debug.Log ("Changing lightmap scale to 0.03f for static baked objects");
//					SerializedObject so = new SerializedObject (renderer);
//					so.FindProperty("m_ScaleInLightmap").floatValue = 0.03f;
