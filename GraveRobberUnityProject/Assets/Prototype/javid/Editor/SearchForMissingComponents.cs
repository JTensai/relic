...
public class SearchForMissingComponents : EditorWindow {
    [MenuItem( "EDITORS/Search For Components" )]
    static void Init () {
		SearchForMissingComponents window = (SearchForMissingComponents) EditorWindow.GetWindow( typeof( SearchForMissingComponents ) );
        window.Show();
